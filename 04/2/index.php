...
<body>
    ...
    <div style="text-align: center;">
        <form action="/profit-php-1/DZ/04/2/upload.php" method="post" enctype="multipart/form-data">
    ...
    <div style="text-align: center;">
        <div class="images-gallery">
            ...
            <?php foreach ($db_images as $key => $image) { ?>
                ...
                <a href="/profit-php-1/DZ/04/2/image.php?id=<?php echo $key; ?>">
                    <img src="/profit-php-1/DZ/04/2/images/<?php echo $image; ?>" alt="<?php echo $image; ?>" width="240">
                </a>
